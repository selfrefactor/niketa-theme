...
const PALLETE_INDEX = 8 //26 29 is max
...
const rules = {
  COLOR_BACK      : [ '#f5f4e8', '#f5f4e8' ],
  COLOR_SECONDARY : [ '#D2D4BF', '#E6DCC2' ],
  COLOR_SELECTION : [ '#b0e4d5', '#FAFAFA' ],
  COLOR_0         : [ '#4E5F52', '#547e80' ],
  COLOR_1         : [ '#4E5F52', '#547e80' ],
  COLOR_5         : [ '#ca434d', '#974545' ],
  COLOR_3         : [ '#974545', '#ca434d' ],
  COLOR_4         : [ '#268bd2', '#268bd2' ],
  COLOR_2         : [ '#268bd2', '#268bd2' ], //d33682
}
