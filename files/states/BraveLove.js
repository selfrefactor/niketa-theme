...
const rulesWithTwoColors = {
  COLOR_BACK      : [ '#f9f6ec', '#f6f6e9' ],
  COLOR_SECONDARY : [ '#c3c1a9', '#CDCBBB' ],
  COLOR_SELECTION : [ '#eec2bb', '#eae3cd' ],
  COLOR_0         : [ '#09686D', fetchTargetComplex(0) ],
  COLOR_1         : [ '#be5588', fetchTargetComplex(1) ],
  COLOR_2         : [ translate('navy.5'), fetchTargetComplex(1) ],
  COLOR_3         : [ translate('brown.8'), fetchTargetComplex(0) ],
  COLOR_4         : [ '#94233d', fetchTargetComplex(1) ],
  COLOR_5         : [ '#5097BE', fetchTargetComplex(1) ],
}
