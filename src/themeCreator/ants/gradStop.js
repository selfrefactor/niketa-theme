!function a (b, c, d) {
  ...
  2 : [ function (a, b, c) {
    (function (b) {
      'use strict';function c (a) { return a && a.__esModule ? a : { default : a } } let d = function () {
          function a (a, b) {
          ...
          let b = [], c = function (a) {
              ...
              for (let c = a.colorArray, e = 1 / (a.stops - 1), g = 0, h = 0;h < a.stops;h++) {
                if (a.inputFormat == 'hex' || a.inputFormat == 'rgb') {
                  let i = (0, f.propBezInterpolate)([ 'r', 'g', 'b' ])(c)(g), j = d(i, 3), k = j[ 0 ], l = j[ 1 ], m = j[ 2 ]

                  b.push((0, f.returnRGBStr)([ k, l, m ]))
                } else if (a.inputFormat == 'hsl') {
                  let n = (0, f.propBezInterpolate)([ 'h', 's', 'l' ])(c)(g), o = d(n, 3), p = o[ 0 ], q = o[ 1 ], r = o[ 2 ]
  ...
  4 : [ function (a, b, c) {
    'use strict';Object.defineProperty(c, '__esModule', { value : !0 }), c.returnHSLStr = c.returnRGBStr = c.extractHSL = c.extractRGB = c.extractHEX = c.propBezInterpolate = void 0;let d = function () {
        function a (a, b) {
          let c = [], d = !0, e = !1, f = void 0
        ...
        let b = (/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i).exec(a), c = b.map(a => parseInt(a, 16)), e = d(c, 4), f = e[ 1 ], g = e[ 2 ], h = e[ 3 ]
    ...
    c.propBezInterpolate = function (a) {
      ...
      return a.map(a => {
        let b = g(a, 4, -1).split(','), c = d(b, 3), e = c[ 0 ], f = c[ 1 ], h = c[ 2 ]
      ...
      return a.map(a => {
        a = g(a, 4, -1).split(',');let b = a[ 0 ], c = g(a[ 1 ], 0, -1), d = g(a[ 2 ], 0, -1)
